...
public class note extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String x=knife.toHtml();
                //String y=x.toString();
                DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Post");
                String postId = ref.push().getKey();
                HashMap<String,Object> map=new HashMap<>();
                map.put("UserId",auth.getInstance().getCurrentUser().getUid());
                map.put("note",knife.toHtml());
                map.put("id",postId);
                ...
                ref.child(postId).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(note.this, "done", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(note.this, home.class));
                            finish();
                        }
                        else
                            Toast.makeText(note.this,"no",Toast.LENGTH_SHORT).show();
                    }
                });
                //FirebaseDatabase.getInstance().getReference().child("Post").child(postId).setValue(map);
    ...
    private void setupBold() {
        ...
        bold.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Toast.makeText(note.this,"toast_bold", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupItalic() {
        ...
        italic.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(note.this, "toast_italic", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupUnderline() {
        ...
        underline.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(note.this, R.string.toast_underline, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupStrikethrough() {
        ...
        strikethrough.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(note.this, R.string.toast_strikethrough, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupBullet() {
        ...
        bullet.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(note.this,"toast_bullet", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupQuote() {
        ...
        quote.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(note.this, R.string.toast_quote, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupLink() {
        ...
        link.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(note.this,"toast_insert_link", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupClear() {
        ...
        clear.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(note.this, R.string.toast_format_clear, Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
